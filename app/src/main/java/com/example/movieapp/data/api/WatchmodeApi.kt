...
interface WatchmodeApi {
    @GET("movie/popular") //end point
    fun getMovies( //method to get popular movies
        @Query("language")language:String="en-US",
        @Query("page") page:Int=1
    ):Single<WatchContentListResponse> // emits list of movies
    ...
    suspend fun getMovieDetails(
        ...
        @Query("language")language:String="en-US"
    ):WatchContentResponse //full details of a movie
